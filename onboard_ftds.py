...
def main(
    ...
    with ApiClient(
        ...
        for ftd_onboarding_input, ftd_ssh_credentials in ftd_onboarding_inputs:
            inventory_api_service.onboard_ftd_device(ftd_input=ftd_onboarding_input)
        for ztp_onboarding_input in ztp_onboarding_inputs:
            inventory_api_service.onboard_ftd_ztp_device(
                ztp_onboarding_input=ztp_onboarding_input
            )
            console.print(f"[green]Onboarded FTD {ztp_onboarding_input.name}[/green]")
